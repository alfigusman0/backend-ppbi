...
module.exports = function validateImportExcelData(rows) {
    ...
    for (let i = 1; i < rows.length; i++) {
        ...
        const rowData = {
            ...
            ids_kelurahan: row[columnMapping['ids_kelurahan']] ? parseInt(row[columnMapping['ids_kelurahan']]) : null,
        ...
        if (isEmpty(rowData.username)) {
            ...
            rowErrors.push('Username hanya boleh mengandung huruf, angka, dan underscore');
        }
        ...
        if (isEmpty(rowData.jenis_kelamin)) {
            ...
            rowErrors.push(`Jenis kelamin harus "LAKI-LAKI" atau "PEREMPUAN", diterima: "${rowData.jenis_kelamin}"`);
        }
