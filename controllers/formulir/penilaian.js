...
Controller.create = async (req, res) => {
  try {
    ...
    const { id_formulir, id_profile, penampilan, gerak_dasar, keserasian, kematangan, keterangan } =
      req.body;
    ...
    const result = await helper.runSQL({
      sql: 'INSERT INTO `tbl_penilaian` (`id_formulir`, `id_profile`, `penampilan`, `gerak_dasar`, `keserasian`, `kematangan`, `keterangan`, `created_by`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
      param: [
        id_formulir,
        id_profile,
        penampilan,
