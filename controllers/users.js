...
Controller.create = async (req, res) => {
  try {
    ...
    const { ids_grup, username } = req.body;
...
Controller.read = async (req, res) => {
  try {
    ...
    const { username, ids_level, level, ids_grup, grup, keterangan, reset } = req.query;
    ...
    addCondition('username', username, 'LIKE');
...
Controller.update = async (req, res) => {
  try {
    ...
    const { ids_grup, username, password, reset } = req.body;
