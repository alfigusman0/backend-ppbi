...
const redisPrefix = process.env.REDIS_PREFIX + 'settings:kelas:';
...
Controller.create = async (req, res) => {
  try {
    ...
    const { kode, nama_kelas, jenis, status } = req.body;
...
Controller.read = async (req, res) => {
  try {
    ...
    const { ids_kelas, ids_kelas_not_in, kode, kode_not_in, nama_kelas, jenis, status } = req.query;
    ...
    addCondition('kode', kode_not_in, 'NOT IN');
